...
class Movies:
	...
	def fetch_list(self):
		...
		try:
			...
			if page_no == 1 and not self.is_external: kodi_utils.set_property('nxtflixlt.exit_params', kodi_utils.folder_path())
	...
	def build_movie_content(self, _position, _id):
		try:
			...
			set_properties({
				...
				'nxtflixlt.extras_params': extras_params,
				'nxtflixlt.options_params': options_params,
				'nxtflixlt.playback_options_params': playback_options_params,
				'nxtflixlt.browse_movie_set_params': browse_movie_set_params,
				'nxtflixlt.browse_recommended_params': browse_recommended_params,
				'nxtflixlt.browse_related_params': browse_related_params,
				'nxtflixlt.browse_more_like_this_params': browse_more_like_this_params,
				'nxtflixlt.browse_similar_params': browse_similar_params,
				'nxtflixlt.browse_in_trakt_list_params': browse_in_trakt_list_params,
				'nxtflixlt.trakt_manager_params': trakt_manager_params,
				'nxtflixlt.personal_manager_params': personal_manager_params,
				'nxtflixlt.tmdb_manager_params': tmdb_manager_params,
				'nxtflixlt.favorites_manager_params': favorites_manager_params
				})
